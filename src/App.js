...
import avatar from "./assets/icons_FEtask/662b9d36e383c902d2fc7874_thumbnail_29.png"
...
const App = () => {
  ...
  // Store the groupBy and sortBy preferences
  useEffect(() => {
  ...
  // Sort the tickets based on the selected sorting option
  ...
  // Count the number of tickets in each group
